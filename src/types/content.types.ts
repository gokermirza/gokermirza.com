 ...
 * @description Configuration for the Videos page that embeds YouTube videos
 * (e.g. the "Kurumsal Pusula" channel).
 */
export interface Videos extends BasePageConfig {
  /** Optional channel URL shown as a call-to-action */
  channelUrl?: string;
  /** List of YouTube videos to embed */
  videos: Array<{
